...
// Load 500+ technical questions from external module
const technicalQuestions = require('./questions');
...
io.on('connection', (socket) => {
    ...
    socket.on('start-game', (settings) => {
        ...
        if (settings.drawTime < 60 || settings.drawTime > 420) {
            socket.emit('join-error', 'Draw time must be between 1 and 7 minutes');
            return;
        }
